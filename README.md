...
- **[`src/cnn_to_tn/`](src/cnn_to_tn/README.md) — Convolutional Neural Networks to Tensor Networks.**
...
- **[`src/bilinear_decomposition/`](src/bilinear_decomposition/README.md) — Weight-based bilinear convolutional model analysis.**
